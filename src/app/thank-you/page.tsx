                ...
                <div className="lg:col-start-2">
                    ...
                    {order._isPaid ? (
                        <p className="mt-2 text-base text-muted-foreground">
                            ...
                            avaliable to download below. We&apos;ve sent your
                        ...
                        <p className="mt-2 text-base text-muted-foreground">
                            ...
                            processing it. So hang tight and we&apos;ll sent
                    ...
                    <div className="mt-16 text-sm font-medium">
                        ...
                        <ul className="mt-6 divide-y divide-gray-200 text-sm font-medium text-muted-foreground">
